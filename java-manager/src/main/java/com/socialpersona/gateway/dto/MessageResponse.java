...
public class MessageResponse {
    ...
    public Boolean getShouldReply() { return shouldReply; }
    public void setShouldReply(Boolean shouldReply) { this.shouldReply = shouldReply; }
